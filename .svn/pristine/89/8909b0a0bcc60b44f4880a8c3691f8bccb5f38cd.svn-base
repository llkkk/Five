...
/**
 * Servlet implementation class UpdateLimits
 */
@WebServlet("/UpdateLimits")
public class UpdateLimits extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int limit=Integer.parseInt(request.getParameter("plmt"));
		if(limit==0) limit=1;
		else limit=0;
		IPersonService ps=new PersonService();
		ps.updateLimits(pid, limit);

		...
		<div class="container">
			...
			<div id="navbar" class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					...
					<li <c:if test="${param.pName eq user_cur.userName}">class="active"</c:if>><a
		...
		<div class="row main">
			...
			<div class="col-md-10">
				<div class="blog">
					...
					<c:forEach items="${lst_blog_cur}" var="blog">
						<div class="content bg-info">
							...
							<c:if test="${blog.userName eq user_cur.userName}">
								<a href="DeleteBlogServlet?bid=${blog.blogId}&from=SelectBlogByUserIdServlet&pid=${user_cur.userId}&pName=${user_cur.userName}"
